    ...
    <div class="col s12 m7">
      <div class="card first">
        <div class="card-image">
          <img src="@/assets/images/prashant.jpeg" height="460px" width="240px">
          <span class="card-title">Prashant Yadav</span>
        </div>
        <div class="card-content">
          <p>I am very enthusiastic about life and I am very passionate to explore and learn more to create beautiful things.</p>
        </div>
        <div class="card-action">
          <a href="#">2000prashant23@gmail.com</a>
        </div>        
      </div>
    </div>
  </div>
